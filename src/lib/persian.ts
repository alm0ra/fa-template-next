...
export function formatPrice(amount: number, unit: string = "تومان"): string {
...
export function formatPersianDateShort(date: Date | number): string {
  return toPersianDigits(format(date, "yyyy/MM/dd", { locale: faIR }));
}
