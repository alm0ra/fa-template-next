...
export function PaymentCallback({
  ...
  const refNumber =
    asString(data?.data?.refNumber) ||
    asString(data?.data?.ref_id) ||
    asString(data?.data?.Shaparak_Ref_Id);
  const cardNumber =
    asString(data?.data?.cardNumber) ||
    asString(data?.data?.card_pan) ||
    asString(data?.data?.card_number);
  const amount = asNumber(data?.data?.amount);
